...
point_cloud_range = [-31.2, -16.8, -5.0, 31.2, 16.8, 3.0]
...
map_grid_conf = {
    'xbound': [-30.0, 30.0, 0.60],
    'ybound': [-15.0, 15.0, 0.60],
    'zbound': [-10.0, 10.0, 20.0],
    'dbound': [1.0, 60.0, 1.0],
}
...
train_pipeline = [
    ...
    # convert map labels
    dict(type='RasterizeMapVectors', map_grid_conf=gt_grid_conf),
...
data = dict(
    ...
    val=dict(type=dataset_type,
             ...
             pipeline=test_pipeline,  bev_size=(data_bev_h_, data_bev_w_),
...
load_from = 'work_dirs/bevformer_bevrestore_lr_bev/latest.pth'
log_config = dict(
    interval=50,
    hooks=[
